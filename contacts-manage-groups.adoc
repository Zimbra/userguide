...
So instead of typing everyone's email address, you type in the name of your list, and {product-name} sends the email to all addresses in that list. 
...
. Drag and drop the contacts in the list that you have created.
