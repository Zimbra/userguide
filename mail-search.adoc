...
4. Type a few words in the **Subject** line, to search emails with these words in their subject line.
5. Type a few words contained in the body of the email in *Contains** field. Enclose the searched text within quotes to search them as a phrase.
6. Specify a date in the **Date** field.
7. Check the boxes **Has attachment** or **Has image** if the email you are looking for has an image or an attachment.
