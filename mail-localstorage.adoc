...
// === Migrate Local folder from old Zimbra app to newer version
...
// . Navigate to
// + 
// On Windows:: `%APPDATA%\@zimbra\<your email address folder>\Mail\<old app local folder>`
// On Mac:: `~/Library/Application Support/@zimbra/<your email address folder>/Mail/<old app local folder>`
// +
// . Copy all the `EML` files in the above folder.
// . Navigate to `@zimbra/storage/<your email address folder>/Mail/NewLocalFolder`.
...
// |Windows
// |`%APPDATA%\@zimbra\\ada@example.com\Mail\OldLocalFolder`
// |`%APPDATA%\@zimbra\storage\\ada@example.com\Mail\NewLocalFolder`

// |Mac
// |`~/Library/Application Support/@zimbra/ada@example.com/Mail/OldLocalFolder`
// |`~/Library/Application Support/@zimbra/storage/ada@example.com/Mail/NewLocalFolder`
// |===
