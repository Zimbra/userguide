...
Always Send:: Choose this option to send a read receipt every time to senders.
Never Send:: Choose this option, so Zimbra does not send a read-receipt to senders.
