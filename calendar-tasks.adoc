== Tasks
=== Create a New List
. Click image:images/graphics/ellipsis-h.svg[3 dots menu icon, width=20]
. Click *Create List...*
...
. Click btn:[Calendar].
. Click image:images/graphics/ellipsis-h.svg[3 dots menu icon, width=20] and choose *New Task*.
+
