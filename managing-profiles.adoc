...
. Click image:images/graphics/rotate_left.svg[counter clockwise arrow icon, width=20] or image:images/graphics/rotate_right.svg[clockwise arrow icon, width=20] to rotate the picture a quarter turn left or right.
