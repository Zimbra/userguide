...
Never:: The selected email stays unread until you mark it as read manually. For details, refer to <<mail-overview.adoc#_reading_pane, reading pane tools>>.
+
. At the bottom of the page, click *Save*.
...
** Click image:images/graphics/close.svg[close icon, width=20] to decline to send a read receipt. 
