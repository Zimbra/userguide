...
==== Email Notifications
You can choose when {product-name} notifies you of new emails.

When a new message arrives in Inbox:: When you choose this option, {product-name} notifies you of new emails *only* whem they arrive in *Inbox*. You are not notified of emails arriving in other folders due to <<settings-filters.adoc, filters>>.

When a new message arrives in any folder:: When you choose this option, {product-name} notifies you of each new email, irrespective of the folder in which they are arriving.