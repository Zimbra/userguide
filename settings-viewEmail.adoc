...
When a new message arrives in Inbox:: When you choose this option, {product-short} notifies you of new emails *only* when they arrive in *Inbox*. You are not notified of emails arriving in other folders due to <<settings-filters.adoc#_filtersautomate_management_of_your_email, filters>>.
